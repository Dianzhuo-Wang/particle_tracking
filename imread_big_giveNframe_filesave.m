...
% Change made to the function:
% Instead of out put result, save result to InfoFolder, naming 'frame#.mat'

function imread_big_giveNframe_filesave(Nframes, stack_name)
...
%     stack_out(:,:,i) = A';
    ...
    if mod(i,100)==0
        disp(['Importing: frame ', num2str(i)])
        toc
    end
